  ...
  return (
    <section className="py-12 md:py-24 px-4 relative overflow-hidden z-30 bg-white rounded-b-[2rem] md:rounded-b-[3rem] shadow-xl mb-0 md:mb-[400px]">
      <div className="max-w-6xl mx-auto relative">
        <div className="bg-[#0F0F0F] rounded-[2rem] md:rounded-[3rem] p-8 md:p-20 text-center relative overflow-hidden shadow-2xl border border-white/5">
          {/* Background Glow */}
          ...
          <div className="relative z-10 pb-4">
            ...
            <BlurFade delay={0} duration={0.5} yOffset={0} blur="0px" inView>
              <h2 className="text-3xl md:text-6xl lg:text-7xl font-bold text-white mb-6 md:mb-8 tracking-tight leading-tight">
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF4D29] to-white">
                  <TextAnimate animation="slideUp" by="word" delay={0.2}>
                    {t('cta-title-2')}
                  </TextAnimate>
                </span>
              </h2>
            ...
            {/* Sous-titre — BlurFade */}
            <BlurFade delay={0.35} duration={0.55} yOffset={12} blur="8px" inView>
              <p className="text-base md:text-xl text-gray-300 mb-10 md:mb-12 max-w-2xl mx-auto font-light">
                {t('cta-subtitle')}
              </p>
            </BlurFade>

            {/* Boutons — BlurFade groupé */}
            <BlurFade delay={0.55} duration={0.5} yOffset={14} blur="8px" inView>
