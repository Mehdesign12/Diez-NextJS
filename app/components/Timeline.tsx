      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto" ref={containerRef}>
          ...
          <div className="space-y-16 md:space-y-24 pt-4">
            {steps.map((step, i) => (
              <BlurFade key={i} delay={0.05 * i} duration={0.6} yOffset={20} blur="10px" inView>
                <div className="relative flex flex-col md:flex-row gap-8 md:gap-0 items-start md:items-center group">
                  {step.side === 'left' ? (
                    <>
                      <div className="pl-16 md:pl-0 md:w-1/2 md:pr-16 md:text-right order-1">
                    ...
                    <>
                      ...
                      <div className="pl-16 md:pl-16 md:w-1/2 md:text-left order-1">
                        <h3 className="text-xl md:text-2xl font-bold mb-2 md:mb-3 text-[#0F0F0F]">{step.title}</h3>
                        <p className="text-gray-500 text-sm md:text-base leading-relaxed">{step.desc}</p>
                      </div>
                    </>
